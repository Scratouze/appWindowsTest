...
def userMainMenu():
    ...
    auth_label_title = Label(
        master=auth_frame,
        text="Bienvenue sur l'interface de connexion",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
    ...
    all_users_button = Button(
        select_auth_frame,
        text="Afficher tout les utilisateurs",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 15),
...
def view_all_users():
    ...
    users_frame_title = Label(
        master=users_frame,
        text="Liste des utilisateurs enregistrés",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
    ...
    if not users:
        user_error_label = Label(
            master=users_list_frame,
            text="Pas d'utilisateur créé",
            background="#1D4291",
            foreground="white",
            font=("Courrier", 15),
        )
...
def create_account():
    ...
    ################################################################
    account_frame_title = Label(
        master=new_account_frame,
        text="Nouveau compte",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    ...
    account_first_name_label = Label(
        master=account_first_name,
        text="Prénom",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
    account_first_name_entry = Entry(
        master=account_first_name,
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    ...
    account_last_name_label = Label(
        master=account_last_name,
        text="Nom",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
    account_last_name_entry = Entry(
        master=account_last_name,
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    ...
    account_balance_label = Label(
        master=account_balance,
        text="Solde actuel",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
...
def create_user():
    ...
    ################################################################
    user_frame_title = Label(
        master=new_user_frame,
...
def accountMainMenu():
    ...
    accounts_label_title = Label(
        master=accounts_frame,
        text="Bienvenue sur l'interface de Gestion des comptes",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
    ...
    connection_button = Button(
        select_account_menu_frame,
        text="Voir tout les comptes",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 15),
...
def view_all_accounts():
    ...
    accounts_frame.pack(expand=YES)
    accounts_frame_title = Label(
        master=accounts_frame,
        text="Liste des comptes enregistrés",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
    ...
    if not accounts:
        user_error_label = Label(
            master=accounts_list_frame,
            text="Pas de compte créé",
            background="#1D4291",
            foreground="white",
            font=("Courrier", 15),
        )
        ...
        for account in accounts:
            ...
            user_delete_button = Button(
                ...
                font=("Courrier", 10),
                command=two_funcs(
                    (lambda: CheckingAccount.deleteAccount(int(accountId))),
                    accountMainMenu,
                ),
            )
            user_delete_button.pack(pady=5, side=RIGHT)
...
def userMasterWindow():
    ...
    label_subtitle = Label(
        master=first_frame,
        text="Votre interface de gestion de comptes",
        background="#1D4291",
        foreground="white",
        font=("Courrier", 20),
    )
